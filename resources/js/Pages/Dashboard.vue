	...
	<AuthenticatedLayout>
			...
			<div class="grid gap-4 lg:grid-cols-3">
				...
				<div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-100 lg:col-span-1">
					<div class="mb-3 flex items-center justify-between">
						...
						<span
							class="inline-flex items-center rounded-full bg-emerald-50 px-2.5 py-0.5 text-[10px] font-medium text-emerald-700"
						>
				...
				<div class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-100 lg:col-span-1">
					<div class="mb-3 flex items-center justify-between">
						...
						<span
							class="inline-flex items-center rounded-full bg-rose-50 px-2.5 py-0.5 text-[10px] font-medium text-rose-700"
						>
		...
		<div class="space-y-6">
			...
			<div class="grid gap-4 md:grid-cols-3 lg:grid-cols-5">
				<div
					class="flex items-center justify-between rounded-xl bg-white px-4 py-3 shadow-sm ring-1 ring-gray-100"
				>
					<div>
			...
			<div class="grid gap-4 lg:grid-cols-3">
				...
				<div
					class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-100 lg:col-span-2"
				>
					<div class="flex items-center justify-between">
						<div>
